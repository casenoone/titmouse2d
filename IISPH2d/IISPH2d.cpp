...
#include "../titmouse2d/src/OtherMethod/IISPH/IISPHSolver2.h"

#include "../titmouse2d/src/random.h"
#include "../titmouse2d/src/TempMovingCollider2.h"
...
auto iisphSolver = std::make_shared<IISphSolver2>();
...
int main(int argc, char** argv)
{
	...
	std::cout << "粒子数目：" << numberOfParticles << std::endl;
	...
	Box2Ptr box2 = std::make_shared<Box2>(Vector2D(0., 0.2), Vector2D(1.8, 0.2), false);
