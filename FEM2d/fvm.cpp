...
//std::initializer_list<Vector2D> pos = { Vector2D(1,1),Vector2D(1,0.90),Vector2D(1.1,0.90) };
...
//std::initializer_list<int> index = { 0,1,2 };
std::initializer_list<Vector2D> pos = { Vector2D(0.98,0.4),Vector2D(1,0.8),Vector2D(1.02,0.4) };
std::initializer_list<int> index = { 0,1,2 };
