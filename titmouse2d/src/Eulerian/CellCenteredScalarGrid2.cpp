...
CellCenteredScalarGrid2::Builder&
CellCenteredScalarGrid2::Builder::withGridSpacing(const Vector2<double>& gridSpacing) {
    _gridSpacing = gridSpacing;
    return *this;
}


CellCenteredScalarGrid2::Builder& CellCenteredScalarGrid2::Builder::withGridSpacing(
    size_t gridSpacingX, size_t gridSpacingY) {
